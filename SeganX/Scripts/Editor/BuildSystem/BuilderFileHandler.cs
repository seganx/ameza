...
namespace SeganX.Builder
{
    public static class BuilderFileHandler
    {
        ...
        public static string RelativePath(string fullpath, string relative)
        {
        ...
        public static class Externals
        {
            ...
            {
                externalPath = Path.GetFullPath(asset).PreparePath(true).BuildPath(); 
            ...
            private static bool BringFile(string filename)
            {
                ...
                var destFilename = MakePath(AssetsFolder, RelativePath(filename, externalPath));
