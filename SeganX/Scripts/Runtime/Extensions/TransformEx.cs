...
namespace SeganX
{
    public static class TransformEx
    {
        ...
        public static T GetComponentInParent<T>(this Transform self, bool inactives)
        {
            if (inactives == false)
        ...
        public static Vector2 LocalPointToLocalPointInRectangle(this RectTransform self, RectTransform destination, Camera camera)
        {
            ...
            var screen = RectTransformUtility.WorldToScreenPoint(cam, worldPoint); // do not use cam.WorldToScreenPoint();

            RectTransformUtility.ScreenPointToLocalPointInRectangle(destination, screen, cam, out Vector2 res);
            return res;
        }
