...
Shader "SeganX/Particle"
{
    Properties
    {
        ...
        _BlinkSpeed("Blink Speed", Float) = 20
        _BlinkRange("Blink Range", Range(0, 0.5)) = 0
            ...
            Pass
            {
                ...
                CGPROGRAM
                    ...
                    VertexOutput vert(VertexInput v)
                    {
                        ...
                        o.col.a *= 1 - _BlinkRange + _BlinkRange * sin(_Time.z * _BlinkSpeed + cos(_Time.w * _BlinkSpeed));
                        return o;
                    }
